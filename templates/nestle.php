...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main nestle">
            ...
            <div class="single-work single-work--atoll">
                <div class="wrapper wrapper--sm">
                    <div class="single-work__intro fadeIn-text">
                        <p>Nestlé Health Science is a leader in the field of nutritional science, committed to redefining the management of health.</p>
                        <div class="single-work__intro-flex">
                            <div class="single-work__intro-flex-item-left">
                                <ul>
                                    <li>Illustrations and Graphic</li>
                                    <li>Design for App Promotion</li>
                                </ul>
                            </div>
                            <div class="single-work__intro-flex-item-right">
                                <div class="entry-content">
                                    <p>In partnership with LEVO Health</p>
                                    <p>The client wanted a promotional campaign for
    an app that improves fertility through nutrition and lifestyle habits.</p>
                                </div>
            ...
            <div class="three-fold-img triger-end">
                <div class="wrapper">
